...
connection_string = 'mysql+pymysql://root:my_password@mysqlcontainer:3306/Veterinarian?autocommit=true'
...
# curl -X GET http://localhost:7002/appointments -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFkbWluIiwicm9sZSI6ImFkbWluIiwiZXhwIjoxNzMyMTQ1ODE0fQ.qFuoDDkKdUaGJy2SQaGtL9bReTfR1a8dYxqVl8uBL_w"
...
# curl -X POST http://localhost:7002/veterinarians -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFkbWluIiwicm9sZSI6ImFkbWluIiwiZXhwIjoxNzI4NTEzMjk0fQ.SnunDQF-eDVbsjoii7-urI3gspINgaOB1bOwG0M4S5o" -H "Content-Type: application/json" -d "{\"id\": \"5\", \"name\": \"Alan\", \"last_name\": \"Walker\", \"phone\": \"0961452365\", \"direction\": \"Argentina\", \"specialization\": \"Cats\"}"
...
# curl -X DELETE http://localhost:7002/veterinarians/5 -H "Authorization: Bearer <token>"
